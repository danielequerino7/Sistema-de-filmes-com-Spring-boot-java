...
public class Filme {
    ...
    @DecimalMin( value = "60", message = "A duração do filme precisa ser maior que 1 hora")
    @DecimalMax( value = "200", message = "A duração do filme precisa ser menor que 3 horas")
